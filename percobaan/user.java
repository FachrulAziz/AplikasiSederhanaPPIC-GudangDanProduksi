...
public class user extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        password.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "= PILIH =", "Kelas 1", "Kelas 2", "Kelas 3", "Kelas 4", "Kelas 5", "Kelas 6" }));
...
login bd = new login();
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        try {
            ...
            String sql = "INSERT INTO satu VALUES ('"+nik.getText()+"','" + nama.getText() +"')";
            PreparedStatement pst = con.prepareStatement(sql);
            pst.execute();
            String sq = "update dua set kelas='"+password.getSelectedItem()+"',alamat='"+username.getText()+"' where kelas='"+password.getSelectedItem()+"'";
    ...
    private javax.swing.JComboBox<String> password;
